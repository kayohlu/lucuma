defmodule Lucuma.Notifications.V2.NotificationConsumer do
  @moduledoc """
  ...
  alias Lucuma.Notifications.V2.NotificationBroadcaster
  ...
  TODO: What we really want is to be able to monitor the notifier task processes
  to see if the die for abnormal reasons and do any cleanup.
  """
  def init(:ok) do
