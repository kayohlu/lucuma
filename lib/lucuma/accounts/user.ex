defmodule Lucuma.Accounts.User do
  use Ecto.Schema
  ...
  schema "users" do
    ...
    belongs_to :inviter, Lucuma.Accounts.User, foreign_key: :invited_by_id

    many_to_many :businesses, Lucuma.Accounts.Business,
      join_through: Lucuma.Accounts.UserBusiness,
